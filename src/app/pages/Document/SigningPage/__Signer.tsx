import { PDF_SCALING_RATIO, baseApi, getFontSizeWithScale, getFormatFromBase64, rgba } from '@esign-web/libs/utils'
...
import { RenderSignerAdd } from './__SignerAdd'
import { SignerDropDown } from './__SignerDropDown'
import { RenderSignerEdit } from './__SignerEdit'
  ...
  const RenderAddButton = (
    <>
      ...
      <MButton
        ...
        sx={{ 
          width: '100%', 
          backgroundColor: 'var(--orange1)', borderRadius: '5px', padding:'7px 12px', border: '2px solid var(--orange)', color: 'var(--orange)', '&:hover': { backgroundColor: 'var(--orange)', '& p': { color: 'var(--white)' } }, transition: 'all 0.4s ease-in-out',  }}
      >
        <Typography
          // prettier-ignore
