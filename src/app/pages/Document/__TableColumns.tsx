...
export const Columns = {
  file: {
    ...
    renderCell: (props: any) => {
      ...
      const FileInfo = (props: any) => {
        return (
          <Box sx={{ display: 'flex', padding: '5px', paddingBottom: '25px' }}>
            <img src={props.thumbnail} style={{ width: '124px', aspectRatio: '11/16', objectFit: 'fill' }} alt="thumbnail" />
            <Box>
      ...
      return (
        <TableBodyCell
          _sx={{ backgroundColor: 'var(--gray2)', padding: 0, minWidth: '200px', position: 'sticky', left: 0, zIndex: 10 }}
          key={key}
        >
  ...
  action: {
    ...
    renderCell: (props: any) => {
      ...
      return (
        <TableBodyCell
          _sx={{ minWidth: '100px', width: '100px', backgroundColor: 'var(--gray2)', position: 'sticky', right: 0 }}
          key={key}
        >
